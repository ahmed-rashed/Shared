function plotFourierTransformPair(t_col,x_cols,f_col, ...
    x_xlabel_Latex,x_Title_Latex, ...
    X_xlabel_Latex,X_Title_Latex, ...
    y_HorizontalLines,horizontalLinesTextLatex, ...
    x_VeticalLines,verticalLinesTextLatex, ...
    Y_HorizontalLines,HorizontalLinesTextLatex, ...
    X_VeticalLines,VerticalLinesTextLatex,sameScale_yY)
